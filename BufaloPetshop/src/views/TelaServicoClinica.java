...
public class TelaServicoClinica extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaServicoClinica frame = new TelaServicoClinica();
	...
	public TelaServicoClinica() {
		...
		JLabel lblNewLabel_5 = new JLabel("Sua senha é: valor random");
		lblNewLabel_5.setBounds(146, 163, 139, 14);
		...
		JLabel lblNewLabel_6 = new JLabel("Aguarde, por favor!");
		lblNewLabel_6.setBounds(295, 163, 113, 14);
